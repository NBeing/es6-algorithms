...
/***/ function(module, exports, __webpack_require__) {
	...
	var num_items = 12;
	var unsorted_list = _.range(num_items).map(function (n) {
	    return getRandomInt(0, num_items);
	});
	var insert_sorted_list = insert_sort(unsorted_list);
	var merge_sorted_list = merge_sort(unsorted_list);
...
/***/ function(module, exports) {
	...
	Array.prototype.halve = function () {
	    ...
	    this.filter(function (el, ind, arr) {
	...
	function merge(arr) {
	    ...
	    var _arr$halve = arr.halve(),
	        _arr$halve2 = _slicedToArray(_arr$halve, 2),
	        left = _arr$halve2[0],
	        right = _arr$halve2[1];
	...
	function merge_sort(arr) {
	    var _arr$halve3 = arr.halve(),
	        _arr$halve4 = _slicedToArray(_arr$halve3, 2),
	        left = _arr$halve4[0],
	        right = _arr$halve4[1];

	    if (right.length == 1) return merge([].concat(_toConsumableArray(left), _toConsumableArray(right)));else return merge([].concat(_toConsumableArray(merge_sort(left)), _toConsumableArray(merge_sort(right))));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function insert(element, list) {
	  ...
	  if (list.length == 0) return [element];

	  return element <= next ? [element, next].concat(_toConsumableArray(rest)) : [next].concat(_toConsumableArray(insert(element, rest)));
	}
